...
public:
	...
	static	_Image*	LoadImage				(const _string sImageFile, int nWidth = -1, int nHeight = -1, bool bConvert32bpp = true);
	...
	BOOL			BitmapOnBitmap			(int xDest, int yDest, _Image* pSrcImage, int xSrc, int ySrc, int nWidthSrc, int nHeightSrc,
